...
public class AddrBean {
	...
	String jdbc_driver = "com.mysql.jsbc.Driver";
	String jdbc_url = "jdbc:mysql://127.0.0.1:3306/jspdb?characterEncoding=UTF-8&serverTimezone=UTC";
	
	void connect() {
		try {
			Class.forName(jdbc_driver);
			
			conn = DriverManager.getConnection(jdbc_url,"root","comeng2019");
		}catch(Exception e) {
			e.printStackTrace();
		}
	}
